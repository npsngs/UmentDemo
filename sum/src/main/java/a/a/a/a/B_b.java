...
public class B_b implements Serializable {
    ...
    public final byte b;
    public final C_c c;
    private static Map<Class<? extends SerialBean>, Map<? extends UMField, B_b>> d = new HashMap();
    ...
    public static void put(Class<? extends SerialBean> var0, Map<? extends UMField, B_b> var1) {
        d.put(var0, var1);
    }

    public static Map<? extends UMField, B_b> a(Class<? extends SerialBean> aClass) {
