...
public class UMEnvelopeData {
    ...
    public byte[] envelope() {
        Envelope umEnvelope = new Envelope();
        ...
        try {
            return new NBeanPacker().pack2Bytes(umEnvelope);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public void writeToCache(Context context) {
        ...
        try {
            ...
            EncodeTool.writeToFile(new File(cacheDir, "exchangeIdentity.json"), jsonObject.toString());
        ...
        try {
            ...
            if(umid != null) {
                jsonObject.put("umid", EncodeTool.getMD5(umid));
            }

            EncodeTool.writeToFile(new File(context.getFilesDir(), "exid.dat"), jsonObject.toString());
        } catch (Throwable throwable) {
            throwable.printStackTrace();
        }
