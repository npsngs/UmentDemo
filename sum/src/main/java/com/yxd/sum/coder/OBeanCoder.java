...
public class OBeanCoder extends BeanCoder {
    private static final BeanName h = new BeanName();
    ...
    public OBeanCoder(IOStream var1) {
        this(var1, false, true);
    }

    public OBeanCoder(IOStream var1, boolean var2, boolean var3) {
        super(var1);
        this.c = false;
        this.d = true;
    ...
    public void startPack(BeanName var1) {
    }
    ...
    public void writeArrayHeader(ArrayHeader var1) throws UMException {
        this.writeByte(var1.type);
        this.writeUnsignedInt(var1.size);
    }
    ...
    public static class UMBeanCoder_a_Builder implements BeanCoderBuilder {
        protected boolean a;
        protected boolean b;
        protected int c;
        ...
        public BeanCoder build(IOStream ioStream) {
            OBeanCoder var2 = new OBeanCoder(ioStream, this.a, this.b);
            if(this.c != 0) {
