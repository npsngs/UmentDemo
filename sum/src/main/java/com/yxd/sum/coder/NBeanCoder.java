...
public class NBeanCoder extends BeanCoder {
    private static final BeanName NAME = new BeanName("");
    ...
    public NBeanCoder(IOStream ioStream, long maxLength) {
        super(ioStream);
    ...
    public NBeanCoder(IOStream ioStream) {
        this(ioStream, -1L);
    }
    ...
    public void startPack(BeanName name) throws UMException {
    ...
    public void writeArrayHeader(ArrayHeader arrayHeader) throws UMException {
        this.write(arrayHeader.type, arrayHeader.size);
    }

    public void writeBoolean(boolean value) throws UMException {
        if(this.o != null) {
            this.a(this.o, (byte)(value?1:2));
            this.o = null;
        } else {
    ...
    public BeanName startUnpack() throws UMException {
        this.shortStack.push(this.n);
        this.n = 0;
        return NAME;
    }

    public void popStack() throws UMException {
        this.n = this.shortStack.pop();
    }
    ...
    public ArrayHeader readArrayHeader() throws UMException {
        return new ArrayHeader(this.readListHeader());
    }
    ...
    public static class NBeanCoderBuilder implements BeanCoderBuilder {
        private final long maxLength;

        public NBeanCoderBuilder() {
            this.maxLength = -1L;
        }

        public NBeanCoderBuilder(int maxLength) {
            this.maxLength = (long)maxLength;
        }

        public BeanCoder build(IOStream ioStream) {
            return new NBeanCoder(ioStream, this.maxLength);
        }
    }
}
