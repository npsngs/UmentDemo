...
import com.yxd.sum.report.LogReporter;
...
public class EventTracker {
    ...
    private AsyncReporter executeReport1 = null;
    private LogReporter preReport = null;
    private JSONObject jsonObject = null;
    private AsyncReporter executeReport;
    ...
    public EventTracker(Context context) {
        try {
            ...
            this.executeReport = AsyncReporter.getInstance(context);
            this.executeReport1 = AsyncReporter.getInstance(context);
            ...
            if(!TextUtils.isEmpty(this.preReport.track_list)) {
                ...
                if(this.jsonObject != null) {
                    for(int i = 0; i < var1.length; ++i) {
                        String var3 = EncodeTool.getSubstring(var1[i], 128);
    ...
    private void isValidEventID(String var1, JSONObject jsonObject) throws JSONException {
        String var3 = EncodeTool.getSubstring(var1, 128);
        ...
        try {
            ...
            while(iterator.hasNext()) {
                try {
                    ...
                    if(var2 != null) {
                        var3 = EncodeTool.getSubstring(var2, 128);
                        obj = entry.getValue();
                        if(obj != null) {
                            if(obj.getClass().isArray()) {
                                ...
                                var4 = EncodeTool.getSubstring(obj.toString(), 256);
