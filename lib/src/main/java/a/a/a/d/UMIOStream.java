...
public class UMIOStream extends IOStream {
    protected InputStream is = null;
    protected OutputStream os = null;

    protected UMIOStream() {
    }

    public UMIOStream(InputStream is) {
        this.is = is;
    }

    public UMIOStream(OutputStream os) {
        this.os = os;
    }

    public UMIOStream(InputStream is, OutputStream os) {
        this.is = is;
        this.os = os;
    }
